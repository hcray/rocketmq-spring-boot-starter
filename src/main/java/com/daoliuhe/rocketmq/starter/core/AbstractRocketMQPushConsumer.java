 ...
 */
public abstract class AbstractRocketMQPushConsumer<T> extends AbstractRocketMQConsumer<T> {
     ...
     *
     * @param message 消息范型
     * @param extMap  存放消息附加属性的map, map中的key存放在 @link MessageExtConstant 中
     * @return 处理结果
     * @see MessageExtConstant
     */
